...
public class QkartSanity {
    ...
    // public static void maxandwait(RemoteWebDriver driver){
    ...
    public static Boolean TestCase01(RemoteWebDriver driver) throws InterruptedException {
        Boolean status;
        takeScreenshot(driver,"Crio","TestCase01_Start");
        ...
        if (!status) {
            ...
            takeScreenshot(driver,"Crio","TestCase01_Fail");
       ...
       // status = driver.getCurrentUrl().endsWith("/login");
        ...
        logStatus("End TestCase", "Test Case 1: Verify user Registration : ", status ? "PASS" : "FAIL");
        takeScreenshot(driver,"Crio","TestCase01_End");
    ...
    public static Boolean TestCase02(RemoteWebDriver driver) throws InterruptedException {
        Boolean status;
        takeScreenshot(driver,"Crio","TestCase02_Start");
        ...
        takeScreenshot(driver,"Crio","TestCase02_End");
        return !status;
    }
    ...
    public static Boolean TestCase03(RemoteWebDriver driver) throws InterruptedException {
        takeScreenshot(driver,"Crio","TestCase03_Start");
        ...
        takeScreenshot(driver,"Crio","TestCase03_End");
        return true;
    }
    ...
    public static Boolean TestCase04(RemoteWebDriver driver) throws InterruptedException {
        takeScreenshot(driver,"Crio","TestCase04_Start");
        ...
        takeScreenshot(driver,"Crio","TestCase04_End");
        return status;
    }
    ...
    public static Boolean TestCase05(RemoteWebDriver driver) throws InterruptedException {
        Boolean status;
        takeScreenshot(driver,"Crio","TestCase05_Start");
        ...
        takeScreenshot(driver,"Crio","TestCase05_End");
        return status;
    }
    ...
    public static Boolean TestCase06(RemoteWebDriver driver) throws InterruptedException {
        Boolean status;
        takeScreenshot(driver,"Crio","TestCase06_Start");
        ...
        takeScreenshot(driver,"Crio","TestCase06_End");
        return status;
    }
    ...
    public static Boolean TestCase07(RemoteWebDriver driver) throws InterruptedException {
        Boolean status;
        takeScreenshot(driver,"Crio","TestCase07_Start");
        ...
        logStatus("End TestCase",
                "Test Case 7: Verify that insufficient balance error is thrown when the wallet balance is not enough: ",
                status ? "PASS" : "FAIL");
        takeScreenshot(driver,"Crio","TestCase07_End");
        return status;
    }
    ...
    public static Boolean TestCase08(RemoteWebDriver driver) throws InterruptedException {
        ...
        logStatus("Start TestCase", "Test Case 8: Verify Multitab", "DONE");
        ...
        status = registration.registerUser("testUser", "abc@123", true);
        if (!status) {
            logStatus("TestCase 8", "Test Case Failure. Verify Multitab Test Failed", "FAIL");
        }
        ...
        if (!status) {
            logStatus("Step Failure", "User Perform Login Failed", status ? "PASS" : "FAIL");
            logStatus("End TestCase", "Test Case 8: Verify Multitab Test Failed : ", status ? "PASS" : "FAIL");
        }
        ...
        List<WebElement> newTabSearchResults = homePage.getSearchResults();
        if(newTabSearchResults.containsAll(searchResults)) {
        	status= true;
        }
        ...
        logStatus("End TestCase", "Test Case 8: Verified Multitab ", status ? "PASS" : "FAIL");        
    ...
    public static Boolean TestCase09(RemoteWebDriver driver) throws InterruptedException {
       ...
       // status = testcase09(driver,"Privacy Policy",currentUrl);
           ...
           Thread.sleep(2000);
           WebElement pp = driver.findElement(By.xpath("//*[@id='root']/div/div[2]/h2"));
           if(!pp.getText().equals("Privacy Policy")) {
            return false;
           }   
           driver.switchTo().window(parent);
       // verify Terms of Service
       driver.findElement(By.cssSelector("a[href='terms-of-service']")).click();
       // status = testcase09(driver,"Terms of Service",currentUrl);
       windows = driver.getWindowHandles();
       driver.switchTo().window(windows.toArray(new String[windows.size()])[2]);
       Thread.sleep(2000);
       if(!driver.findElement(By.xpath("//*[@id='root']/div/div[2]/h2")).getText().equals("Terms of Service")) {
        return false;
       }   
    ...
    Boolean status = false;
    // TODO: CRIO_TASK_MODULE_SYNCHRONISATION -
    logStatus("Start TestCase", "Test Case 10: Verify Contact Us Page Test: ", "DONE");
    ...
    if (!status) {
        logStatus("Step Failure", "User Perform Registration Failed", status ? "PASS" : "FAIL");
        logStatus("End TestCase",
                "Test Case 10: Verify Contact Us Page Test: ",
                status ? "PASS" : "FAIL");
        return false;
    }
    ...
    WebElement msg = driver.findElement(By.xpath("//input[@placeholder='Message']"));
        msg.sendKeys("Testing the contact us page");
    driver.findElement(By.xpath("/html/body/div[2]/div[3]/div/section/div/div/div/form/div/div/div[4]/div/button")).click();

    logStatus("End TestCase", "Test Case 10: Verify Contact Us Page Test ", status ? "PASS" : "FAIL");
...
public static Boolean TestCase11(RemoteWebDriver driver) throws InterruptedException {
    ...
    if(count!=3) {
       logStatus("End TestCase", "Test Case 11: Verify Advertisements: ", status ? "PASS" : "FAIL");
        return false;
    }
    ...
    logStatus("End TestCase", "Test Case 11: Verify Advertisement 1 buttons are clickable: ", status ? "PASS" : "FAIL");
    ...
    driver.switchTo().parentFrame();
    status = !driver.getCurrentUrl().equals(currentUrl);
    logStatus("End TestCase", "Test Case 11: Verify Advertisement 2 buttons are clickable: ", status ? "PASS" : "FAIL");
